    ...
    <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
        <div class="container">
            ...
            <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
                <ul class="navbar-nav ml-5 pl-5">
                    <li class="nav-item ml-5 pl-5">
                        <a class="nav-link active" href="innerindex.php">Home</a>
                    </li>
                    <li class="nav-item ml-3">
                        <a class="nav-link" href="#">About Us</a>
                    </li>
                    <li class="nav-item ml-3">
                        <a class="nav-link" href="innercourses.php">Courses</a>
                    </li>
                    <li class="nav-item ml-3">
            ...
            <form action="action.php" method="post" enctype="multipart/form-data">
                <button type="button" name="logout" class="btn btn-b-n text-white d-md-block mr-3 bg-danger" data-toggle="tooltip" data-placement="bottom" title="Log Out"> <span class="fas fa-sign-out-alt"></span>
                </button>
            </form>

            <button type="button" class="btn btn-b-n navbar-toggle-box-collapse d-md-block" data-toggle="collapse tooltip" data-target="#navbarTogglerDemo01" aria-expanded="false" data-placement="bottom" title="Search">
                <span class="fa fa-search" aria-hidden="true"></span>
            </button>
        </div>
    </nav>
                ...
                <div class="col-md-12">
                    <div class="title-wrap d-flex justify-content-between">
                        ...
                        <div class="title-link">
                            <a href="innericourses.css">All Courses
                                <span class="ion-ios-arrow-forward"></span>
                            </a>
                        </div>
                    </div>
