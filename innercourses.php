                    ...
                    <table class="">
                        <tbody>
                            ...
                            foreach ($Effect as $row) {
                                ...
                                $video = $row["Video"];
                                echo "<a href class='col-md-3 ml-3 border bg-light rounded'>";
                                echo "<div class='w-100 mt-4 '><img src='upload/$img' class='w-100' style='height:160px;'></div>";
                                // echo $id;

                                echo "<h3 class='mt-3'>" . $row['Cou_Name'] . "</h3>";
                                echo "<div >The most difficult thing is the decision to act, the rest is merely tenacity. The fears are ...</div>";
